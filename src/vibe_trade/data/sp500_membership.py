...
CHANGES: list[tuple[str, str | None, str | None]] = [
    ("2026-08-18", 'RDDT', None),
    ("2026-08-05", 'FERG', 'EA'),
    ("2026-06-30", None, 'CAG'),
    ("2026-06-29", 'HONA', None),
    ("2026-06-22", 'MRVL', 'POOL'),
    ("2026-06-22", 'FLEX', 'CPB'),
    ("2026-06-02", None, 'EPAM'),
    ("2026-06-01", 'FDXF', None),
    ...
    ("2025-03-24", 'EXE', 'FMC'),
    ("2024-12-23", 'APO', 'QRVO'),
    ("2024-12-23", 'WDAY', 'AMTM'),
    ("2024-12-23", 'LII', 'CTLT'),
    ("2024-11-26", 'TPL', 'MRO'),
    ("2024-10-01", None, 'BBWI'),
    ("2024-09-30", 'AMTM', None),
    ("2024-09-23", 'PLTR', 'AAL'),
    ("2024-09-23", 'DELL', 'ETSY'),
    ("2024-09-23", 'ERIE', 'BIO'),
    ("2024-06-24", 'KKR', 'RHI'),
    ("2024-06-24", 'CRWD', 'CMA'),
    ("2024-06-24", 'GDDY', 'ILMN'),
    ("2024-05-08", 'VST', 'PXD'),
    ("2024-04-03", None, 'XRAY'),
    ("2024-04-03", None, 'VFC'),
    ("2024-04-02", 'GEV', None),
    ("2024-04-01", 'SOLV', None),
    ("2024-03-25", 'CPAY', 'FLT'),
    ("2024-03-18", 'SMCI', 'WHR'),
    ("2024-03-18", 'DECK', 'ZION'),
    ("2024-02-01", 'DAY', 'CDAY'),
    ("2023-12-18", 'UBER', 'SEE'),
    ("2023-12-18", 'JBL', 'ALK'),
    ("2023-12-18", 'BLDR', 'SEDG'),
    ("2023-10-18", 'HUBB', 'OGN'),
    ("2023-10-18", 'LULU', 'ATVI'),
    ("2023-10-03", None, 'DXC'),
    ("2023-10-02", 'VLTO', None),
    ("2023-10-02", 'VLTO', None),
    ("2023-09-18", 'BX', 'LNC'),
    ("2023-09-18", 'ABNB', 'NWL'),
    ("2023-08-25", 'KVUE', 'AAP'),
    ...
    ("2022-10-03", 'EQT', 'DRE'),
    ("2022-09-19", 'CSGP', 'PVH'),
    ("2022-09-19", 'INVH', 'PENN'),
    ("2022-06-21", None, 'UA'),
    ("2022-06-21", 'KDP', 'UAA'),
    ("2022-06-21", 'ON', 'IPGP'),
    ("2022-06-08", 'VICI', 'CERN'),
    ("2022-04-11", 'WBD', 'DISCA'),
    ("2022-04-11", None, 'DISCK'),
    ("2022-04-04", 'CPT', 'PBCT'),
    ("2022-03-02", 'MOH', 'INFO'),
    ...
    ("2020-04-06", None, 'M'),
    ("2020-04-06", None, 'RTN'),
    ("2020-04-03", 'OTIS', None),
    ("2020-04-03", 'CARR', None),
    ("2020-04-01", 'HWM', 'ARNC'),
    ("2020-03-02", 'IR', 'XEC'),
    ("2020-01-28", 'PAYC', 'WCG'),
    ("2019-12-23", 'LYV', 'AMG'),
    ...
    ("2018-03-19", 'TTWO', 'SIG'),
    ("2018-03-19", 'SIVB', 'PDCO'),
    ("2018-03-19", 'NKTR', 'CHK'),
    ("2018-03-07", 'IPGP', 'SNI'),
    ("2018-01-03", 'HII', 'BCR'),
    ("2017-11-15", 'IQV', 'Q'),
    ("2017-10-13", 'NCLH', 'LVLT'),
    ("2017-09-18", 'CDNS', 'SPLS'),
    ("2017-09-01", 'DWDP', 'DOW'),
    ("2017-09-01", 'SBAC', 'DD'),
    ("2017-08-29", 'Q', 'WFM'),
    ("2017-08-08", 'BHF', 'AN'),
    ...
    ("2015-12-29", 'CHD', 'ALTR'),
    ("2015-12-15", None, 'CMCSK'),
    ("2015-12-01", 'CSRA', 'CSC'),
    ("2015-11-19", 'ILMN', 'SIAL'),
    ("2015-11-18", 'SYF', 'GNW'),
    ("2015-11-02", 'HPE', 'HCBK'),
    ("2015-10-07", 'VRSK', 'JOY'),
    ("2015-09-18", 'CMCSK', None),
    ("2015-09-18", 'FOX', None),
    ("2015-09-18", 'NWS', None),
    ("2015-09-02", 'UAL', 'HSP'),
    ("2015-08-28", 'ATVI', 'PLL'),
